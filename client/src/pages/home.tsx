      ...
      >
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
          ...
          <motion.p 
            ...
            className="text-xl md:text-2xl text-white/95 mb-8 font-medium"
          >
          ...
          >
            ...
            <Link href="/reservations">
              <Button 
                size="lg" 
                variant="outline"
                className="h-12 px-8 text-lg font-semibold bg-white/10 backdrop-blur-sm border-white/30 text-white hover:bg-white/20 hover:scale-105 transition-transform"
                      ...
                      <div className="absolute bottom-0 right-0 left-0 p-6">
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <Link href="/menu">
                            <Button 
                              size="sm"
                              className="bg-white/10 backdrop-blur-sm border-white/30 text-white hover:bg-white/20 hover:scale-110 transition-transform"
                              variant="outline"
